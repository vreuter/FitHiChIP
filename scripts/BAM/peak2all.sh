...
# peak to all (either peak or non peak)  interaction (-M 0)
# equal occupancy spline + binomial model (-f 1 and -B 1)
# distance thresholds: 10 Kb and 3 Mb
# no of threads = 8 (-t)
#$codeexec -I $AlignFile -P $PeakFile -o $OutDir -n $PREFIX -t 8 -v 1 -L 10000 -U 3000000 -f 1 -B 1 -M 0 -D 1
$codeexec -I $AlignFile -o $OutDir -n $PREFIX -t 8 -v 1 -L 10000 -U 3000000 -f 1 -B 1 -M 0 -D 1
